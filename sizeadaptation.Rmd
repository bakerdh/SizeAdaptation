...
download.file('https://github.com/bakerdh/SizeAdaptation/blob/main/elife.csl')
}
if (!file.exists('references.bib')){
download.file('https://github.com/bakerdh/SizeAdaptation/blob/main/references.bib')
}
